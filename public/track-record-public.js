...
(function () {
  ...
  // Mirrors trCatalystInfo() in app.js — duplicated here since this page
  // deliberately doesn't load app.js. Keep the two in sync when a new
  // auto-recorder catalyst type is added.
